...
if(isset($_POST['add_std'])){
    ...
    $insert = "INSERT INTO `student` (`fname`, `lname`, `mobilenumber`, `email`, `password`)
...
<body>
    ...
    <section class="add-std">

        <span class="title">Add Student</span>

        <div class="add-std-container">

            <form action="" class="std-form" method="post" enctype="multipart/form-data">
                <div class="input">
                ...
                <div class="add-std-btn">
                    <button name="add_std">Add Student</button>
                </div>
            </form>
        </div>
